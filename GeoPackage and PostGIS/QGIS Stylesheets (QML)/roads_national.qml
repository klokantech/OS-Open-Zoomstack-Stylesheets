  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" symbol="0" label="Level 2">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Primary'" key="{10941eb0-09e8-4851-b48d-40de2393bd56}" symbol="1" scalemindenom="1" label="Primary"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Motorway'" key="{11c8fe02-c64b-414f-8a3a-8738e3521cd2}" symbol="2" scalemindenom="1" label="Motorway"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Primary'" key="{462cca7c-fa1d-423f-8b41-ef9f93574d1a}" symbol="3" scalemindenom="1" label="Primary case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Motorway'" key="{0d13cd99-4dbb-405d-b9a9-08dfcadd0fd3}" symbol="4" scalemindenom="1" label="Motorway case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="5" label="Level 1">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Primary'" key="{ba3e7c84-6d3f-4ad3-91c9-e5b328fd9e7b}" symbol="6" scalemindenom="1" label="Primary"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Motorway'" key="{b3e3165d-bbcf-4a8b-9a00-86e90159b3bf}" symbol="7" scalemindenom="1" label="Motorway"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Primary'" key="{876fec5c-5ee7-4148-baa9-66d3c9d83803}" symbol="8" scalemindenom="1" label="Primary case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Motorway'" key="{720bad62-6bf6-46ba-bdd2-11aa02ef2e5f}" symbol="9" scalemindenom="1" label="Motorway case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="10" label="Level 0">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Primary'" key="{ba3e7c84-6d3f-4ad3-91c9-e5b328fd9e7b}" symbol="11" scalemindenom="1" label="Primary"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Motorway'" key="{b3e3165d-bbcf-4a8b-9a00-86e90159b3bf}" symbol="12" scalemindenom="1" label="Motorway"/>
      </rule>
      <rule key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" symbol="13" label="Mid-scale Roads">
        <rule scalemaxdenom="5000000" filter="&quot;type&quot; = 'Primary'" key="{de4d130a-6355-44d7-83e4-c7f8ed9fc64b}" symbol="14" scalemindenom="40000" label="Primary"/>
        <rule scalemaxdenom="5000000" filter="&quot;type&quot; = 'Motorway'" key="{c854c78d-894f-47d5-a957-bba084de07eb}" symbol="15" scalemindenom="40000" label="Motorway"/>
      </rule>
    </rules>
    <symbols>
