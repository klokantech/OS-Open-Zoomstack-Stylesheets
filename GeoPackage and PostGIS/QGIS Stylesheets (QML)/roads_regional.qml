...
<qgis version="2.18.14" simplifyAlgorithm="0" minimumScale="1" maximumScale="1e+06" simplifyDrawingHints="3" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1.5" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule scalemaxdenom="80000" filter="&quot;type&quot; = 'Tunnel'" key="{20e35827-a110-4126-9315-cc669dbdc846}" symbol="0" scalemindenom="1" label="Tunnel"/>
      <rule filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" symbol="1" label="Level 2">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'B Road'" key="{1c669a79-337e-42af-8871-c38fe54f694d}" symbol="2" scalemindenom="1" label="B Road"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'A Road'" key="{213a46e6-1e62-4cca-ae89-ff6db6811476}" symbol="3" scalemindenom="1" label="A Road"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'B Road'" key="{f17ad428-7663-40d5-947a-db011751145c}" symbol="4" scalemindenom="1" label="B Road case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'A Road'" key="{8820e4fe-80f1-443f-a22c-4fab1f851f2d}" symbol="5" scalemindenom="1" label="A Road case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="6" label="Level 1">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'B Road'" key="{682456c2-d450-4d3d-9086-16f8e7ae37c6}" symbol="7" scalemindenom="1" label="B Road"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'A Road'" key="{94e900e4-ffd2-408f-b471-22ec16ee0c01}" symbol="8" scalemindenom="1" label="A Road"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'B Road'" key="{7a6f6c21-539f-4ca3-bc47-ddee66112bb3}" symbol="9" scalemindenom="1" label="B Road case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'A Road'" key="{a3130444-5961-4062-815c-5f0d52a3cb08}" symbol="10" scalemindenom="1" label="A Road case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="11" label="Level 0">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'B Road'" key="{682456c2-d450-4d3d-9086-16f8e7ae37c6}" symbol="12" scalemindenom="1" label="B Road"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'A Road'" key="{a3130444-5961-4062-815c-5f0d52a3cb08}" symbol="13" scalemindenom="1" label="A Road"/>
      </rule>
      <rule key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" symbol="14" label="Mid-scale Roads">
        <rule scalemaxdenom="640000" filter="&quot;type&quot; = 'B Road'" key="{ac3f366c-5f02-4af3-8b77-8208128d9972}" symbol="15" scalemindenom="40000" label="B Road"/>
        <rule scalemaxdenom="1000000" filter="&quot;type&quot; = 'A Road'" key="{9b033ca7-9b61-49db-85a6-188288ad18be}" symbol="16" scalemindenom="40000" label="A Road"/>
      </rule>
    </rules>
    <symbols>
