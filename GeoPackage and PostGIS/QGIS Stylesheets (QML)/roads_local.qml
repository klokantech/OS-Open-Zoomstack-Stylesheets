...
<qgis version="2.18.14" simplifyAlgorithm="0" minimumScale="1" maximumScale="80000" simplifyDrawingHints="3" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1.5" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" symbol="0" label="Level 2">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Restricted'" key="{1df55981-99e1-48f0-9992-decee51ed6e8}" symbol="1" scalemindenom="1" label="Restricted"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Minor'" key="{a7819b1d-b312-44e0-adf6-8f6d01499527}" symbol="2" scalemindenom="1" label="Minor"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Local'" key="{49842030-120b-4a0e-88f9-291f2351cda6}" symbol="3" scalemindenom="1" label="Local"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Minor'" key="{4d8a61b8-73ce-4765-bcb5-0e5b1d5a8946}" symbol="4" scalemindenom="1" label="Minor case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Local'" key="{88882149-9355-4953-97a2-ecef80ae416d}" symbol="5" scalemindenom="1" label="Local case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="6" label="Level 1">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Restricted'" key="{53a70991-f1c9-484e-9060-f76ca9c1f1e4}" symbol="7" scalemindenom="1" label="Restricted"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Minor'" key="{1b86ee7d-d21e-47fd-9dc3-47c1cdf2b10d}" symbol="8" scalemindenom="1" label="Minor"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Local'" key="{d6e05cfa-dbee-4508-af7c-7927c3c7031a}" symbol="9" scalemindenom="1" label="Local"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Minor'" key="{7ba3bb0c-ba8e-405b-a93e-54ab84f0f53a}" symbol="10" scalemindenom="1" label="Minor case"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Local'" key="{23b598d6-30e9-4dff-9d54-8fbe0eb5c126}" symbol="11" scalemindenom="1" label="Local case"/>
      </rule>
      <rule filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" symbol="12" label="Level 0">
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Restricted'" key="{53a70991-f1c9-484e-9060-f76ca9c1f1e4}" symbol="13" scalemindenom="1" label="Restricted"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Minor'" key="{1b86ee7d-d21e-47fd-9dc3-47c1cdf2b10d}" symbol="14" scalemindenom="1" label="Minor"/>
        <rule scalemaxdenom="40000" filter="&quot;type&quot; = 'Local'" key="{d6e05cfa-dbee-4508-af7c-7927c3c7031a}" symbol="15" scalemindenom="1" label="Local"/>
      </rule>
      <rule key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" symbol="16" label="Mid-scale Roads">
        <rule scalemaxdenom="80000" filter="&quot;type&quot; = 'Minor'" key="{adc09698-c877-4b14-afdb-bde03e5828b0}" symbol="17" scalemindenom="40000" label="Minor"/>
      </rule>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/scaleMax" value="80000"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="number" expression=""/>
